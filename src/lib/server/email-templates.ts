...
<html lang="en">
  <body style="margin:0;background:#090a08;color:#f3f0e8;font-family:Arial,sans-serif">
    <div style="max-width:600px;margin:0 auto;padding:40px 24px">
      ...
      ${action}
      <p style="margin:42px 0 0;padding-top:18px;border-top:1px solid #2b2f27;color:#777d72;font-size:12px;line-height:1.6">Vixel UGC · Source-grounded creator campaign planning</p>
    </div>
  </body>
</html>`;
}
...
export function lifecycleEmail(
  ...
  switch (type) {
    ...
    case "welcome": {
      const body = `${greeting} your passwordless Vixel UGC account is ready. If your beta access is still pending, the Studio will open automatically after approval.`;
      return {
    ...
    case "invitation": {
      const body = `${greeting} your Vixel UGC Studio invitation is live. Sign in with this email to enter the campaign room.`;
      return {
        subject: "Your Vixel UGC Studio invitation",
        text: `${body}\n\n${siteUrl}/studio`,
        html: shell({
    ...
    case "invitation_reminder": {
      const body = `${greeting} a quick reminder that your Vixel UGC Studio invitation is still available. Sign in with this email before the invitation window closes.`;
      return {
